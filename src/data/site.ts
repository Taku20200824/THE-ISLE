...
export const siteConfig = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL ?? "https://the-isle-asia.vercel.app",
  discordInvite: process.env.NEXT_PUBLIC_DISCORD_INVITE ?? "https://discord.gg/the-isle-asia",
  serverIp: process.env.NEXT_PUBLIC_SERVER_IP ?? "theisle-asia.example.com:7777",
